...
def make_restaurant(name, location, categories, price, reviews):
    ...
    # BEGIN Question 2
    "*** YOUR CODE HERE ***"
    return {'name': name, 'location': location, 'categories': categories, 'price': price, 'reviews': reviews, 'review ratings': [review_rating(r) for r in reviews]}
    # END Question 2
...
def restaurant_ratings(restaurant):
    ...
    # BEGIN Question 2
    return restaurant['review ratings']
    # END Question 2
